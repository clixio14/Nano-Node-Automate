...
echo "    • Your phone with a password manager app installed"
echo -e "      (${CYAN}Bitwarden${NC}, ${CYAN}1Password${NC}, ${CYAN}Proton Pass${NC}, ${CYAN}KeePassXC${NC}, etc.)"
...
echo "============================================================================"
echo ""
echo -e "  ${RED}This is shown ONCE. Nano Noder does NOT save it anywhere.${NC}"
echo -e "  ${RED}If you lose this seed, your representative account is gone forever.${NC}"
echo ""
echo "  Your 64-character seed (triple-click to select, then copy):"
echo ""
...
echo "    1. Open Bitwarden, 1Password, Proton Pass, or similar"
...
echo ""
echo -e "  ${BOLD}Option 3 — Both (best practice)${NC}"
echo ""
echo "  ────────────────────────────────────────────────────────────────"
echo ""
