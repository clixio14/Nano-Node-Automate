...
")
    ...
    # Placeholder fields — to be wired up after representative.sh is built
    rep_address_display="-"
    voting_display="No"
    ...
    rep_address_display="$INIT"
    voting_display="$INIT"
    voting_weight_display="$INIT"
    voting_weight_pct_display="$INIT"
  fi
  ...
  echo -e " Type \e[1;96mrep\e[0m to setup representative | Type \e[1;96mbandwidth\e[0m to optimize bandwidth"
  echo -e " To check dashboard again (if stopped) just type \e[93mdashboard\e[0m"
  echo -e " For more info on your node go to \e[94mwww.nanonodeauto.com\e[0m"
  echo "======================================================================"
}
