...
")
  ...
  echo -e " Type \e[35mrep\e[0m to setup representative | Type \e[35mbandwidth\e[0m to optimize bandwidth"
  echo -e " To check dashboard again (if stopped) just type \e[93mdashboard\e[0m"
  echo -e " For more info on your node go to \e[34mwww.nanonodeauto.com\e[0m"
  echo "======================================================================"
}
